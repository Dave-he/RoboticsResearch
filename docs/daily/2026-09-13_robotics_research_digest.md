...
### 3. Ludi${}_{\scriptscriptstyle 0.1}$: An Agentic System for Socially Intelligent Robots
...
2. [Measuring Language Transfer in Robot Policies: Adding Greek to a Cosmos3 Vision-Language-Action Policy](https://arxiv.org/abs/2609.07470v1) — score 10
3. [The Embodiment Gap in Robot Foundation Models](https://arxiv.org/abs/2608.18433v1) — score 8
