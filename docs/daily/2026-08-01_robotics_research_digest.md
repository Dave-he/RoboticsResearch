...
- **arXiv**: [2607.26991v2](https://arxiv.org/abs/2607.26991v2)  ·  **PDF**: [link](https://arxiv.org/pdf/2607.26991v2)
...
### 4. Isaac Sim-to-Real: Reinforcement Learning based Locomotion for Quadrupeds
...
### 10. Reinforcement Learning on Cost-Constrained Quadrupedal Hardware

- **arXiv**: [2607.26434v2](https://arxiv.org/abs/2607.26434v2)  ·  **PDF**: [link](https://arxiv.org/pdf/2607.26434v2)
...
### 3. Cross-Embodiment Transfer via Behavior-Aligned Representations
...
### 4. UniCross: Unified Cross-Skill Dexterous Manipulation Synthesis
...
### 5. CheckVLA: Execution-Time Verification with Action-Conditioned World Model for Long-Horizon Mobile Manipulation
