...
- **arXiv**: [2608.12308v1](https://arxiv.org/abs/2608.12308v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2608.12308v1)
- **作者**: Yan Deng, Fei Xu
- **发表**: 2026-08-12  ·  **类别**: cs.CV, cs.AI
- **相关性评分**: 11  ·  **👀 watch**
- **摘要**: Aerial vision-language navigation (VLN) requires an embodied agent to integrate visual evidence over time, plan future actions, and determine when it has reached a navigation goal under partial observability. Although recent VLA models offer a promising perception-to-action paradigm, adapting them to aerial navigation remains challenging due to limited hist…

### 2. FIRE-VLA: Failure-Informed Self-Evolution for Vision-Language-Action Models in Autonomous Driving

- **arXiv**: [2608.13395v1](https://arxiv.org/abs/2608.13395v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2608.13395v1)
- **作者**: Hao Dou
- **发表**: 2026-08-13  ·  **类别**: cs.RO
- **相关性评分**: 8  ·  **👀 watch**
- **摘要**: Reinforcement learning improves autonomous-driving vision-language-action (VLA) models by evaluating trajectories sampled from the current policy. Group relative policy optimization (GRPO) learns from reward differences within each rollout group. When all sampled trajectories are poor, this relative signal can rank failures without identifying behavior outs…

### 3. Temporal GRPO: Beyond Trajectory-Level Credit in Vision-Language-Action Reinforcement Learning

- **arXiv**: [2608.13026v1](https://arxiv.org/abs/2608.13026v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2608.13026v1)
- **作者**: Yao Zhou, Hang Gao, Fengge Wu et al.
- **发表**: 2026-08-13  ·  **类别**: cs.RO
- **相关性评分**: 8  ·  **👀 watch**
- **摘要**: Outcome-driven reinforcement learning offers a scalable way to post-train vision-language-action (VLA) policies from sparse task-success feedback. In common GRPO-based VLA post-training, one rollout-level advantage is applied to every action in the trajectory. A rollout that completes several valid stages but fails later can therefore penalize the actions t…

### 4. Self-Evolving Embodied Agents via Skill-Harness Evolution

- **arXiv**: [2608.11350v1](https://arxiv.org/abs/2608.11350v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2608.11350v1)
- **作者**: Peidong Wang, Zhiming Ma, Ying Chang et al.
- **发表**: 2026-08-11  ·  **类别**: cs.CL, cs.RO
- **相关性评分**: 8  ·  **👀 watch**
- **摘要**: Embodied agents are increasingly built as systems around foundation models, where performance depends not only on model weights but also on the skills, context, action interfaces, and execution harness surrounding the model. While supervised fine-tuning and reinforcement learning can adapt agents to new environments, they require additional data, rewards, a…
...
- **arXiv**: [2608.12854v1](https://arxiv.org/abs/2608.12854v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2608.12854v1)
- **作者**: Bing Zhan, Shuyao Shang, Jiahao Gu et al.
- **发表**: 2026-08-13  ·  **类别**: cs.RO, cs.AI, cs.CV
- **相关性评分**: 5  ·  **📌 info**
- **摘要**: Autonomous driving requires planning under both semantic constraints and predictive dynamics. Existing end-to-end driving approaches, however, typically emphasize only one side of this requirement: Vision-Language-Action (VLA) models exploit VLM priors for semantic reasoning, while World Action Models (WAMs) provide future-aware prediction through generativ…
...
- **arXiv**: [2608.13420v1](https://arxiv.org/abs/2608.13420v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2608.13420v1)
- **作者**: Aimilios Hadjiliasi, Louis Nisiotis
- **发表**: 2026-08-13  ·  **类别**: cs.AI
- **相关性评分**: 9  ·  **👀 watch**
...
### 2. Multi-Submap Implicit Neural SLAM with Local-to-Global Loop Closure for Large-Scale Scene Reconstruction
...
### 4. Semantic Radiance Fields as Simulators for Spatial Reasoning in Real-World Scenes

- **arXiv**: [2608.13095v1](https://arxiv.org/abs/2608.13095v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2608.13095v1)
- **作者**: Nico Heider, Michał Jan Włodarczyk, Katarzyna Wasielewska-Michniewska et al.
- **发表**: 2026-08-13  ·  **类别**: cs.RO, cs.CV
- **相关性评分**: 5  ·  **📌 info**
- **摘要**: Training and evaluating spatial reasoning in embodied agents requires diverse environments that are both geometrically faithful and semantically queryable. Synthetic simulators offer ground truth semantics but sacrifice realism; simulators based on reconstructions of real-world environments have realistic appearance but lack ground truth semantics by defaul…

### 5. Spatial Memory Agent: Experience-Grounded Procedure Memory for Spatial Intelligence

- **arXiv**: [2608.12743v1](https://arxiv.org/abs/2608.12743v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2608.12743v1)
- **作者**: Haokai Zhang, Yuhang Ding, Yunshu Zhou et al.
- **发表**: 2026-08-13  ·  **类别**: cs.AI
- **相关性评分**: 5  ·  **📌 info**
- **摘要**: Spatial intelligence is becoming a foundation for embodied agents, robotic planning, and multimodal assistants. To improve the spatial reasoning ability of VLM agents, existing work has mainly followed two lines. One line uses post-training methods, such as supervised fine-tuning and reinforcement learning. Another line adopts an agentic paradigm in which t…

### 6. FUSE: Active Functional Affordance Grounding through Adaptive Semantic-Geometric Evidence Acquisition

- **arXiv**: [2608.12683v1](https://arxiv.org/abs/2608.12683v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2608.12683v1)
- **作者**: Zhou Chen, Sathyanarayanan N. Aakur
- **发表**: 2026-08-13  ·  **类别**: cs.RO, cs.CV
- **相关性评分**: 5  ·  **📌 info**
- **摘要**: Embodied agents must often identify and interact with objects based on their function rather than their identity, requiring them to actively acquire observations that reveal discriminative functional evidence. Existing affordance grounding methods operate from fixed viewpoints and lack mechanisms for deciding where to look when functional cues are occluded…

### 7. Map-Det3D: Metric Feed-Forward 3D Reconstruction Prior for Multi-view 3D Object Detection from Streaming Inputs

- **arXiv**: [2608.12179v1](https://arxiv.org/abs/2608.12179v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2608.12179v1)
- **作者**: Yung-Hsu Yang, Luigi Piccinelli, Samuel Rota Bulò et al.
- **发表**: 2026-08-12  ·  **类别**: cs.CV
- **相关性评分**: 5  ·  **📌 info**
- **摘要**: Metric 3D object detection is a core capability for embodied agents, yet most reliable systems lean on depth sensors, trading away cost, power, and integration simplicity. This motivates monocular 3D detection, which avoids additional constraints, yet it faces a major obstacle: from a single image, depth, and especially absolute scale, are underconstrained.…

### 8. Hypothesis-driven Model Expansion under Uncertainty for Open-World Robot Planning
...
- **arXiv**: [2608.12063v1](https://arxiv.org/abs/2608.12063v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2608.12063v1)
- **作者**: Martin Schuck, Maks Sorokin, Simone Manni et al.
- **发表**: 2026-08-12  ·  **类别**: cs.RO, cs.AI
- **相关性评分**: 16  ·  **🔥 read_now**
- **摘要**: Integrating locomotion and manipulation is essential for robot autonomy, but scaling standard Reinforcement Learning (RL) to complex tasks is severely bottlenecked by the slow, manual process of dense reward shaping. To bypass this limitation, we leverage Sample-based Model Predictive Control (SMPC) entirely in simulation as an automated, rapidly tunable ex…
...
- **arXiv**: [2608.11769v1](https://arxiv.org/abs/2608.11769v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2608.11769v1)
- **作者**: Chaeyeon Jung, Juyoun Park
- **发表**: 2026-08-12  ·  **类别**: cs.RO
- **相关性评分**: 14  ·  **🔥 read_now**
- **摘要**: Vision-language-action (VLA) policies are expected to operate robustly across variations in the robot's initial configuration, yet aggregate task success can conceal pose-specific failures and inappropriate hand selection. This work investigates initial-pose dependence in VLA-based humanoid dual-arm manipulation. We characterize the initial-condition-depend…
...
### 5. NestDex: Nested Policy Learning with Copilot Assisted Teleoperation for Dexterous Manipulation
...
### 6. SAFE-CHEM: Uncertainty-Aware Policy Switching for Robust Robotic Chemistry
...
### 8. HandEdit: A Unified Benchmark for Egocentric Human-to-Robot Dexterous Hand Image Editing

- **arXiv**: [2608.12122v1](https://arxiv.org/abs/2608.12122v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2608.12122v1)
- **作者**: Zhenjie Yang, Xingyu Jiao, Guopeng Zhong et al.
- **发表**: 2026-08-12  ·  **类别**: cs.RO, cs.CV
- **相关性评分**: 12  ·  **🔥 read_now**
- **摘要**: Robotic manipulation with dexterous hands is a cornerstone of Embodied AI, yet its progress is stifled by the high cost of collecting embodiment-aware teleoperation data. While abundant egocentric videos of human hands offer a scalable alternative, the profound discrepancies in appearance, articulation, and camera viewpoints between human and robotic data r…
...
### 10. G0.5: One Autoregressive Stream for Robot Reasoning and Action

- **arXiv**: [2608.11739v1](https://arxiv.org/abs/2608.11739v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2608.11739v1)
- **作者**: Yicheng Liu, Zibin Dong, Baijun Ye et al.
- **发表**: 2026-08-12  ·  **类别**: cs.RO, cs.AI
- **相关性评分**: 11  ·  **👀 watch**
- **摘要**: The prevailing recipe for Vision-Language-Action (VLA) models couples a pretrained VLM with a separately trained flow-matching action expert. This makes the VLM a context encoder rather than a decision-maker. We introduce G0.5, a pretrained autoregressive VLA in which a single transformer decoder emits reasoning and action tokens under a single objective. T…

## 🎓 模仿学习 / 强化学习 (15 篇)

### 1. DaViNCi: A Dataset Towards Outdoor Vision-and-Language Navigation with Continuous Actions and Dynamic Elements

- **arXiv**: [2608.11901v1](https://arxiv.org/abs/2608.11901v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2608.11901v1)
- **作者**: Zihao Xie, Pingrui Lai, Yitong Wu et al.
- **发表**: 2026-08-12  ·  **类别**: cs.RO
- **相关性评分**: 9  ·  **👀 watch**
- **摘要**: Vision-and-Language Navigation (VLN) has progressively expanded from indoor to outdoor environments. However, existing outdoor VLN datasets still rely on fixed discrete topological graphs for construction. It fails to align with the rapidly changing real-world outdoor environments and impedes the sim-to-real transfer of VLN agents. To address this limitatio…

### 2. Overcoming Data Scarcity and Confidentiality in Hardware Assurance via Synthetic Generation
