# 机器人研究每日摘要 · 2026-07-12

> 自动生成,共 88 篇命中论文。

## 🧠 视觉-语言-动作模型 (VLA) (2 篇)

### 1. Post-Training in End-to-End Autonomous Driving

- **arXiv**: [2607.08072v1](https://arxiv.org/abs/2607.08072v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2607.08072v1)
- **作者**: Ruining Yang, Muxing Wang, Yixiao Chen et al.
- **发表**: 2026-07-09  ·  **类别**: cs.CV, cs.RO
- **相关性评分**: 9  ·  **👀 watch**
- **摘要**: End-to-end models that map multimodal inputs directly to future trajectories/maneuvers have emerged as an increasingly prominent research paradigm in autonomous driving. This class of models includes both Vision-Language-Action models and trajectory-generative planners. Unlike classic machine learning applications, autonomous vehicles operate in safety-crit…

### 2. LEEVLA: Seeing What Matters in Latent Environment Evolution for Vision-Language-Action

- **arXiv**: [2607.08182v1](https://arxiv.org/abs/2607.08182v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2607.08182v1)
- **作者**: Qi Lyu, Baicheng Liu, Xudong Wang et al.
- **发表**: 2026-07-09  ·  **类别**: cs.CV, cs.AI
- **相关性评分**: 8  ·  **👀 watch**
- **摘要**: Vision-language-action (VLA) models aim to map multimodal inputs to robot actions. However, most existing approaches struggle to cover complex dynamic scenarios due to treating all visual tokens uniformly and reasoning with human-selected factors, which lack mechanisms to emphasize task-critical evidence and ignore underlying factors. To address this issue,…
...
### 2. Early to Share, Late to Save: Synchronisation-Driven Communication Gating in Bandwidth-Constrained Cooperative VLN

- **arXiv**: [2607.08504v1](https://arxiv.org/abs/2607.08504v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2607.08504v1)
- **作者**: Arav Gupta, Nivedan Yakolli, Avinash Gautam
- **发表**: 2026-07-09  ·  **类别**: cs.MA, cs.RO
- **相关性评分**: 9  ·  **👀 watch**
...
### 4. Overloading Large Vision-Language Models for Jailbreaking
...
### 5. Path-level Hindsight Instructions for Semantic Exploration in Vision-Language Navigation
...
### 2. Immersive Social Interaction with VR and LLM-Assisted Humanoids
...
### 9. CWI: Composite Humanoid Whole-Body Imitation System for Loco-manipulation
...
### 5. GraspIT: A Dataset Bridging the Sim-to-Real gap and back for Validated Grasping SE(3) Pose Generation
...
### 7. Harness VLA: Steering Frozen VLAs into Reliable Manipulation Primitives via Memory-Guided Agents

- **arXiv**: [2607.08448v1](https://arxiv.org/abs/2607.08448v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2607.08448v1)
- **作者**: Yixian Zhang, Huanming Zhang, Feng Gao et al.
- **发表**: 2026-07-09  ·  **类别**: cs.RO
- **相关性评分**: 16  ·  **🔥 read_now**
- **摘要**: Language-conditioned manipulation requires both precise contact-rich control and robust reasoning over language, scenes, and long horizons. End-to-end Vision-Language-Action (VLA) models provide strong local visuomotor skills, but they are trained on in-distribution task trajectories and often fail under deployment perturbations such as semantic retargeting…

### 8. Current as Touch: Proprioceptive Contact Feedback for Compliant Dexterous Manipulation
...
### 10. SPEAR: A Simulator for Photorealistic Embodied AI Research

- **arXiv**: [2607.06701v1](https://arxiv.org/abs/2607.06701v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2607.06701v1)
- **作者**: Mike Roberts, Renhan Wang, Rushikesh Zawar et al.
- **发表**: 2026-07-07  ·  **类别**: cs.CV, cs.AI, cs.GR
- **相关性评分**: 14  ·  **🔥 read_now**
- **摘要**: Interactive simulators have become powerful tools for training embodied agents and generating synthetic visual data, but existing photorealistic simulators suffer from limited generality, programmability, and rendering speed. We address these limitations by introducing SPEAR: A Simulator for Photorealistic Embodied AI Research. At its core, SPEAR is a Pytho…
...
- **arXiv**: [2607.07885v1](https://arxiv.org/abs/2607.07885v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2607.07885v1)
- **作者**: Erik Jagnandan, Mulugeta Haile, Gregory Barber et al.
- **发表**: 2026-07-08  ·  **类别**: cs.RO, cs.AI, cs.CV
- **相关性评分**: 9  ·  **👀 watch**
- **摘要**: Dynamic obstacle avoidance in unstructured outdoor environments remains a critical challenge for autonomous mobile robots, particularly when large-scale robot-specific training data and simulation-based policies are impractical. We present a data-efficient, interpretable method for vision-based dynamic obstacle avoidance that operates entirely on real-world…
...
- **arXiv**: [2607.07763v1](https://arxiv.org/abs/2607.07763v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2607.07763v1)
- **作者**: Eli Laird, Corey Clark
- **发表**: 2026-07-08  ·  **类别**: cs.LG
- **相关性评分**: 5  ·  **📌 info**
- **摘要**: World models are typically trained to predict discrete-time physical dynamics with a fixed step size baked into the model weights, preventing prediction at variable temporal resolutions. This matters for hierarchical planning, sim-to-real transfer, and scientific or game-engine applications that must query the same dynamics at multiple timescales. Hamiltoni…

### 9. Learning to Throw Objects Safely in Multi-Obstacle Environments
...
### 10. Onnes: A Physics-Grounded Multi-Agent LLM Simulator for Cryogenic Fault Diagnosis in Quantum Computing Infrastructure
...
### 1. PLED-VINS: A Point-Line Event-Based Visual Inertial SLAM for Dynamic Environments
...
**建议今日深读 (Top 3):**
1. [DexVerse: A Modular Benchmark for Multi-Task, Multi-Embodiment Dexterous Manipulation](https://arxiv.org/abs/2607.08751v1) — score 24
2. [Closing the Reality Gap: Zero-Shot Sim-to-Real Deployment for Dexterous Force-Based Grasping and Manipulation](https://arxiv.org/abs/2607.04940v1) — score 23
3. [LAMP: Latent Motion Prior-Guided Real-World Learning for Dexterous Hand Manipulation](https://arxiv.org/abs/2607.06323v1) — score 22
