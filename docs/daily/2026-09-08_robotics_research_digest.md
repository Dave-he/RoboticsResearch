...
### 2. HitMem: Hierarchical Temporal 3D Memory with Multi-Modal Context-Aware Retrieval for Dynamic Environments
...
### 4. DSG: Dynamic 3D Scene Graph Construction for Embodied Agents in Changing Indoor Environments
...
### 5. SmoothRL: Online Reinforcement Learning During Asynchronous Execution
...
### 5. LabDex: A Hierarchical Benchmark for Dexterous Manipulation in Laboratories
...
### 6. ZETA: A Controlled Study of Zero-Shot Cross-Embodiment VLA Transfer for Tabletop Manipulation
...
**建议今日深读 (Top 3):**
1. [Does Imitation Learning Preserve Temporal Robustness in Dexterous Manipulation? An Expert-Learner Comparison Across Task Execution Speeds](https://arxiv.org/abs/2609.01453v1) — score 22
2. [A System for Fast, Resilient, and Adaptable Loco-Manipulation Behaviors on Humanoid Robots](https://arxiv.org/abs/2609.01518v1) — score 20
3. [RoboSPA: Can VLA Models Go Beyond Simple Scenes and Short-Horizon Tasks?](https://arxiv.org/abs/2609.05324v1) — score 19
