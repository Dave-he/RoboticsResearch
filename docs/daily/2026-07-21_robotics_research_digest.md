...
### 4. What Do They See? Interpreting Complex Road Scenarios Through the Eyes of Vision-Language-Action Models for Safe and Trustworthy Autonomous Vehicle Learning
...
### 7. Knowing You at First Glance: Inferring Apparent Personality from Faces
...
### 8. TactiDex: A Real-World Tactile-Guided Benchmark for Human-Like Dexterous Manipulation
...
### 10. Foresight Residual RL for Long-Horizon Robot Manipulation with Vision-Language-Action Models
