...
### 1. Do Vision-Language-Action Models Mean What They Say? On the Role of Faithfulness in Embodied Reasoning

- **arXiv**: [2607.04681v1](https://arxiv.org/abs/2607.04681v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2607.04681v1)
- **作者**: Matthew Foutter, Matteo Cercola, Lena Wild et al.
- **发表**: 2026-07-06  ·  **类别**: cs.RO, cs.AI
- **相关性评分**: 12  ·  **🔥 read_now**
- **摘要**: Embodied Chain-of-Thought has emerged as a promising mechanism to enhance robot decision-making and interpretability in black-box Vision-Language Action (VLA) models. However, whether this verbalized Chain-of-Thought truthfully reflects the policy's underlying decision process remains poorly understood. We distinguish between functional reasoning, in which…
...
### 1. Overloading Large Vision-Language Models for Jailbreaking
...
### 2. Path-level Hindsight Instructions for Semantic Exploration in Vision-Language Navigation
...
### 4. ScaRF-SLAM: Scale-Consistent Reconstruction with Feed-Forward Models and Classical Visual SLAM
...
### 8. EgoSafetyBench: A Diagnostic Egocentric Video Benchmark for Evaluating Embodied VLMs as Runtime Safety Guards
...
### 9. MVP-Nav: Multi-layer Value Map Planner Navigator
...
### 5. Reinforcement Learning-Based Control for an Inline Skating Humanoid Robot
...
### 8. CWI: Composite Humanoid Whole-Body Imitation System for Loco-manipulation
...
- **arXiv**: [2606.30243v1](https://arxiv.org/abs/2606.30243v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2606.30243v1)
...
### 3. Current as Touch: Proprioceptive Contact Feedback for Compliant Dexterous Manipulation
...
### 5. SILO: Simulation-in-the-Loop Sim-to-Real Transfer for Multi-Stage Cable Routing
...
### 6. WSA$_1$: a 3D-Centric World-Spatial-Action Model for Generalizable Robot Control
...
### 7. VLA Grounder: Language-Conditioning Space Optimization for Black-Box VLA Models
...
- **arXiv**: [2607.03570v1](https://arxiv.org/abs/2607.03570v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2607.03570v1)
- **作者**: Luis Felipe Casas, Robert Teal, Keval Shah et al.
- **发表**: 2026-07-03  ·  **类别**: cs.RO
- **相关性评分**: 14  ·  **🔥 read_now**
- **摘要**: Robot manipulation policies are typically tied to specific robotic hand embodiments, limiting the transfer of learned behaviors across platforms with different kinematic structures. In this work, we propose the Unified Hand Action Space (UHAS), a sphere-based unified action representation for cross-embodiment dexterous manipulation. UHAS represents robotic…
...
- **arXiv**: [2607.04451v1](https://arxiv.org/abs/2607.04451v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2607.04451v1)
- **作者**: Ke Li, Kaidi Liang, Yuxin Ding et al.
- **发表**: 2026-07-05  ·  **类别**: cs.CV
- **相关性评分**: 5  ·  **📌 info**
- **摘要**: Evaluation of autonomous vehicle (AV) planners in safety-critical closed-loop simulation is essential for real-world deployment. However, generating controllable safety-critical scenarios remains challenging. Existing approaches use soft guidance that provides only probabilistic preferences and cannot guarantee the satisfaction of geometric and severity con…

### 8. Anticipatory Reinforcement Learning for Trajectory Tracking

- **arXiv**: [2607.03132v1](https://arxiv.org/abs/2607.03132v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2607.03132v1)
- **作者**: Georg Schäfer, Jakob Rehrl, Stefan Huber et al.
- **发表**: 2026-07-03  ·  **类别**: cs.LG, cs.RO
- **相关性评分**: 5  ·  **📌 info**
- **摘要**: Deep reinforcement learning (DRL) in industrial control often suffers from lag and overshoot due to purely reactive control based on the current tracking error. To achieve anticipatory control without high computational overhead, we introduce a predictive formulation that augments the DRL state space with target velocities and future reference horizons. Eva…
...
2. [RoboTacDex: A Dexterous Visual-Tactile-Action Dataset for Humanoid Manipulation](https://arxiv.org/abs/2606.31836v1) — score 22
