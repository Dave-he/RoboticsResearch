...
### 6. The Moving Eye: Enhancing VLA Spatial Generalization via Hybrid Dynamic Data Collection
...
### 8. Function-based Parametric Co-Design Optimization of Dexterous Hands
...
- **arXiv**: [2607.02092v1](https://arxiv.org/abs/2607.02092v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2607.02092v1)
...
### 10. Efficient Sim-to-Real Transfer of World-Action Models from Synthetic Priors

- **arXiv**: [2606.31101v1](https://arxiv.org/abs/2606.31101v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2606.31101v1)
- **作者**: Zixing Wang, Kausik Sivakumar, Jinghuan Shang et al.
- **发表**: 2026-06-30  ·  **类别**: cs.RO
- **相关性评分**: 10  ·  **👀 watch**
- **摘要**: Bridging the sim-to-real gap is a core challenge in deploying learned manipulation policies. Sim-to-real learning is attractive because it can replace expensive real robot demonstrations with scalable synthetic data, yet world-action models have not previously been shown to transfer from simulation to real robotic manipulation. We study whether a world-acti…
