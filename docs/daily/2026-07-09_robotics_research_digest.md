...
### 4. Labimus: A Simulation and Benchmark for Humanoid Dexterous Manipulation in Chemical Laboratory
...
### 5. Multi-Rate Nonlinear Model Predictive Control for Wall-Supported Bipedal Locomotion of Quadrupedal Robots
...
### 7. Reinforcement Learning-Based Control for an Inline Skating Humanoid Robot
...
- **arXiv**: [2607.07287v1](https://arxiv.org/abs/2607.07287v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2607.07287v1)
...
### 8. SILO: Simulation-in-the-Loop Sim-to-Real Transfer for Multi-Stage Cable Routing
...
### 8. Onnes: A Physics-Grounded Multi-Agent LLM Simulator for Cryogenic Fault Diagnosis in Quantum Computing Infrastructure
...
3. [TouchWorld: A Predictive and Reactive Tactile Foundation Model for Dexterous Manipulation](https://arxiv.org/abs/2607.07287v1) — score 20
