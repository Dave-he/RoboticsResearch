...
### 6. EMPIRE: Explicit Manipulation Planning as a Learnable Intermediate Representation for Egocentric Hand-Motion Forecasting
...
### 9. Fiber Optic Sensing Glove for High Performance Dexterous Manipulation Capture
