...
- **arXiv**: [2608.09467v1](https://arxiv.org/abs/2608.09467v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2608.09467v1)
- **作者**: Boxiong Wang, Hui Kang, Geng Sun et al.
- **发表**: 2026-08-10  ·  **类别**: cs.CV, cs.AI
- **相关性评分**: 9  ·  **👀 watch**
- **摘要**: Unmanned aerial vehicle vision-language navigation (UAV-VLN) requires agents to translate visual observations and language instructions into reliable flight actions in complex environments. Although recent end-to-end UAV vision-language-action (UAV-VLA) policies reduce reliance on separately designed perception, planning, and control modules, their behavior…
...
### 4. Action- and Language-Conditioned Video Assessment for Embodied Control
...
- **arXiv**: [2608.07905v1](https://arxiv.org/abs/2608.07905v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2608.07905v1)
- **作者**: Chen Li, Sijie Cheng, Yuelin Zhang et al.
- **发表**: 2026-08-08  ·  **类别**: cs.AI, cs.RO
- **相关性评分**: 9  ·  **👀 watch**
- **摘要**: Embodied agents using LLM-based planners often struggle with physical hallucinations, poor generalization to long-horizon tasks, and lack of environmental awareness. We propose GraphThink, a novel framework that integrates a task graph to provide structured knowledge for robust planning and a scene graph to maintain environmental memory for event-driven rep…
...
### 6. Compiling and Benchmarking Task-State Horizons for Embodied Agents

- **arXiv**: [2608.08036v1](https://arxiv.org/abs/2608.08036v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2608.08036v1)
- **作者**: Meiqi Wang, Shichao Li
- **发表**: 2026-08-08  ·  **类别**: cs.RO
- **相关性评分**: 8  ·  **👀 watch**
- **摘要**: Frontier agentic models are increasingly deployed as high-level planners for long-horizon embodied tasks. Existing robotic benchmarks have advanced long-horizon evaluation, but primarily characterize difficulty through action-sequence length and subtask complexity, overlooking a distinct challenge: agents must track evolving task-relevant world states induc…
...
### 8. SAIN: Structure-Aware Interactive Navigation with Active Dialogue Grounding for Mobile Robot
...
- **arXiv**: [2608.06756v1](https://arxiv.org/abs/2608.06756v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2608.06756v1)
- **作者**: Ying Chen, Weizhen Li, Zhe Hu et al.
- **发表**: 2026-08-07  ·  **类别**: cs.AI
- **相关性评分**: 5  ·  **📌 info**
- **摘要**: Vision-language models are increasingly serving as the reasoning core of embodied agents. Robot execution is inherently iterative: each action reshapes the scene and physical state, continually renewing what must be perceived, reasoned about, and verified. Meeting these demands requires complementary capabilities that differ in supervision signals, predicti…
...
### 6. Handroid: Bridging Dexterous Hand and Humanoid
...
### 1. Skills in Weights, Memory in Code: Hybrid Learning for Memory-Dependent Robot Manipulation

- **arXiv**: [2608.09410v1](https://arxiv.org/abs/2608.09410v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2608.09410v1)
- **作者**: Yunhao Zhao, Zhenyang Ni, Haoyang Chen et al.
- **发表**: 2026-08-10  ·  **类别**: cs.RO
- **相关性评分**: 16  ·  **🔥 read_now**
- **摘要**: Modern vision-language-action (VLA) policies have acquired broad manipulation skills, but typically generate each action chunk from the current observation or a short fixed-length history. However, real-world manipulation is often non-Markovian, requiring robots to retain and reason over task-relevant information from long-horizon interaction histories to d…

### 2. Trajectory Divergence Horizon Decision for Reliable Dual-Arm Surgical Subtask Manipulation

- **arXiv**: [2608.09125v1](https://arxiv.org/abs/2608.09125v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2608.09125v1)
- **作者**: Mingwu Su, Guankun Wang, Jinsong Lin et al.
- **发表**: 2026-08-10  ·  **类别**: cs.RO
- **相关性评分**: 16  ·  **🔥 read_now**
- **摘要**: Surgical robotic systems are increasingly being adopted as clinical workload rises, motivating autonomous solutions for repetitive manipulation subtasks. Learning-based controllers improve generalization compared with rule-based and analytic approaches, but most are trained for individual tasks and remain difficult to reuse across procedures. Vision-Languag…
...
### 4. VANE: Reliable Test-Time Training for Vision-Language-Action Models via Future Visual Representation Prediction

- **arXiv**: [2608.09448v1](https://arxiv.org/abs/2608.09448v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2608.09448v1)
- **作者**: Hongjin Ji, Guoyang Xia, Luoyang Sun et al.
- **发表**: 2026-08-10  ·  **类别**: cs.RO, cs.CV
- **相关性评分**: 14  ·  **🔥 read_now**
- **摘要**: Test-time training (TTT) offers a lightweight way to adapt vision--language--action (VLA) policies from unlabeled deployment streams, but it remains difficult to use reliably in closed-loop manipulation. A shared adaptation space can mix incompatible task corrections, while an online update can alter subsequent actions before its consequences are known. We…
...
### 7. SAFE-CHEM: Uncertainty-Aware Policy Switching for Robust Robotic Chemistry
...
### 9. SiMDex: Mining Similar Egocentric Videos for Cross-Embodiment Dexterous Manipulation
...
### 10. ReTouch: Empowering Contact-Rich Dexterous Manipulation with Online-Refined Tactile Prediction
