# 机器人研究每日摘要 · 2026-08-18

> 自动生成,共 87 篇命中论文。

## 🧠 视觉-语言-动作模型 (VLA) (4 篇)

### 1. Exposing the Long-tail in Embodied Urban Navigation via Scalable Learning from In-the-Wild Videos

- **arXiv**: [2608.16476v1](https://arxiv.org/abs/2608.16476v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2608.16476v1)
- **作者**: Bingyi Xia, Han Bao, Zhewei Chen et al.
- **发表**: 2026-08-17  ·  **类别**: cs.RO
- **相关性评分**: 9  ·  **👀 watch**
- **摘要**: Learning embodied urban navigation policies from real-world data is constrained by the cost of task-specific data collection and the limited coverage of rare yet safety-critical scenarios. To address these challenges, we present a scalable framework for learning point-goal urban navigation from web-scale in-the-wild egocentric videos while systematically ex…

### 2. GigaBrain-0.7: Scaling Embodied Foundation Models to Emergent Capabilities with a Three-System Architecture
...
### 1. FloodReasonBench: Benchmarking VLM Reasoning Segmentation for Embodied Flood Response at the Edge

- **arXiv**: [2608.15410v1](https://arxiv.org/abs/2608.15410v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2608.15410v1)
- **作者**: Rajat Bhattacharjya, Yoomee Jung, Minwoo Kim et al.
- **发表**: 2026-08-15  ·  **类别**: cs.DC, cs.AI, cs.CV
- **相关性评分**: 9  ·  **👀 watch**
- **摘要**: Reasoning segmentation enables vision-language models (VLMs) to translate mission-relevant language requests into pixel-level visual grounding, offering a natural perception interface for embodied agents. However, existing benchmarks largely focus on generic visual scenes and overlook the domain and resource constraints encountered in flood-response platfor…

### 2. Implementing Computational Law in Wolfram Language for the Governance of Artificial Intelligence

- **arXiv**: [2608.13958v1](https://arxiv.org/abs/2608.13958v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2608.13958v1)
- **作者**: James K. Wiles
- **发表**: 2026-08-14  ·  **类别**: cs.AI, cs.CY, cs.LO
- **相关性评分**: 9  ·  **👀 watch**
- **摘要**: How do we govern AI systems whose reasoning we cannot fully inspect? Governance does not require understanding a system's reasoning. It requires stating what the system is obliged, permitted, and forbidden to do, and checking whether it complied. I present an implementation of Reified Input/Output Logic, the formalism behind the DAPRECO knowledge base, in W…
...
### 8. THRIVE: Therapeutic Humanoid Robot In Virtual Environment
...
### 10. Throwing a Tight Spiral American Football by a Humanoid Robot
...
### 3. When State Becomes an Attack Surface: State-Semantic Injection in LLM-Driven Embodied Agents
...
- **arXiv**: [2608.16889v1](https://arxiv.org/abs/2608.16889v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2608.16889v1)
- **作者**: Bingxin Xu, Yuzhang Shang, Emilio Ferrara
- **发表**: 2026-08-17  ·  **类别**: cs.RO, cs.AI, cs.CV
- **相关性评分**: 14  ·  **🔥 read_now**
- **摘要**: Long-horizon robot manipulation chains many contact-rich skills into one multi-stage task. Vision-language-action (VLA) models increasingly master the individual skills, yet the chain still fails: errors compound beyond the policy's ability to correct, and one subtask silently constrains the next. A promising recipe freezes the VLA and puts an LLM agent in…
...
- **arXiv**: [2608.16503v1](https://arxiv.org/abs/2608.16503v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2608.16503v1)
- **作者**: Cong Zhao, Shuai Tian, Xu Zhang et al.
- **发表**: 2026-08-17  ·  **类别**: cs.RO, cs.AI
- **相关性评分**: 13  ·  **🔥 read_now**
- **摘要**: Real-world deployment of Vision-Language-Action (VLA) models is often bottlenecked by efficiency-performance trade-offs, cross-embodiment generalization, and execution smoothness. We present NebulaVLA, an asynchronous dual-frequency architecture that decouples high-level semantic reasoning from low-level action control, optimizing computational resources an…
...
### 6. AgilePE: Autonomous UAV Pursuit-Evasion via Self-Play Reinforcement Learning

- **arXiv**: [2608.14135v1](https://arxiv.org/abs/2608.14135v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2608.14135v1)
- **作者**: Wenhao Tang, Tianyang Chen, Zhejun Cui et al.
- **发表**: 2026-08-14  ·  **类别**: cs.RO, cs.LG
- **相关性评分**: 5  ·  **📌 info**
- **摘要**: Autonomous pursuit-evasion is a fundamental challenge for Unmanned Aerial Vehicles (UAVs), requiring rapid decision-making under tightly coupled dynamics and continuously changing opponent behaviors. Traditional rule-based or differential-game approaches often struggle with high-dimensional aerial interactions and agile maneuvering. We present AgilePE, a co…
...
3. [$τ_0$-VLA: a Hierarchical Robot Foundation Model with World-Model-Guided Test-Time Computation](https://arxiv.org/abs/2608.16885v1) — score 17
