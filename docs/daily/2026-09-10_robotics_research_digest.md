# 机器人研究每日摘要 · 2026-09-10

> 自动生成,共 87 篇命中论文。

## 🧠 视觉-语言-动作模型 (VLA) (3 篇)

### 1. Measuring Language Transfer in Robot Policies: Adding Greek to a Cosmos3 Vision-Language-Action Policy
...
### 8. Establishing a Dynamic Multimodal HRI Dataset for Engagement Analysis with a Humanoid Robot
...
- **arXiv**: [2609.07747v1](https://arxiv.org/abs/2609.07747v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2609.07747v1)
...
### 7. ComVLA: Communication-Aware Split Inference for VLA Models in 6G-Connected Robotics

- **arXiv**: [2609.07838v1](https://arxiv.org/abs/2609.07838v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2609.07838v1)
- **作者**: Boliang Liu, Wint Yi Poe, Jingyun Di et al.
- **发表**: 2026-09-07  ·  **类别**: cs.RO
- **相关性评分**: 16  ·  **🔥 read_now**
- **摘要**: Connected robotics is an emerging 6G application where mobile robots follow natural-language instructions to manipulate physical objects. The Vision-Language-Action (VLA) models that enable this are too large to run on the robot; a common trend is to offload inference to the cloud. The wireless link, however, limits how much sensing data the edge can transm…
...
### 9. ICI-VLA: In-Context Imitation with Spatiotemporally Aligned Demonstrations for Vision-Language-Action Models

- **arXiv**: [2609.07581v1](https://arxiv.org/abs/2609.07581v1)  ·  **PDF**: [link](https://arxiv.org/pdf/2609.07581v1)
- **作者**: Songhua Yang, Ziyu Liu, Xuetao Li et al.
- **发表**: 2026-09-07  ·  **类别**: cs.RO
- **相关性评分**: 14  ·  **🔥 read_now**
- **摘要**: Vision-Language-Action (VLA) policies are commonly adapted to new manipulation settings through additional gradient updates, which limits rapid deployment when task-specific data or compute is scarce. We present ICI-VLA, a training and retrieval framework that equips a text-action VLM with few-shot test-time adaptation through in-context demonstrations. Unl…

### 10. ZETA: A Controlled Study of Zero-Shot Cross-Embodiment VLA Transfer for Tabletop Manipulation
...
**建议今日深读 (Top 3):**
1. [Dex-X: Learning Visual-Tactile Dexterous Manipulation From Human Videos with Simulated Interaction](https://arxiv.org/abs/2609.07747v1) — score 23
